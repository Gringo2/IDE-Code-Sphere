...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  # workaround that enforces x86 ARCH for pkg2appimage having /__w/CodeSphere/CodeSphere/build/linux/appimage/CodeSphere/CodeSphere.AppDir/usr/share/codesphere/resources/app/node_modules/rc/index.js is of architecture armhf
  export ARCH=x86_64
