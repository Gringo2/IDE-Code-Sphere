...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:focal-devtoolset-x64"

  export VSCODE_SKIP_SETUPENV=1
elif [[ "${VSCODE_ARCH}" == "arm64" ]]; then
  EXPECTED_GLIBC_VERSION="2.30"

  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:focal-devtoolset-arm64"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:focal-devtoolset-armhf"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:focal-devtoolset-ppc64le"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:focal-devtoolset-riscv64"

  export VSCODE_SKIP_SETUPENV=1
  export VSCODE_NODEJS_SITE='https://unofficial-builds.nodejs.org'
elif [[ "${VSCODE_ARCH}" == "loong64" ]]; then
  NODE_VERSION="20.16.0"
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:beige-devtoolset-loong64"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="CodeSphere/CodeSphere-linux-build-agent:focal-devtoolset-s390x"
  VSCODE_SYSROOT_PREFIX="-glibc-${GLIBC_VERSION}"
