...
- Linux: https://github.com/CodeSphere/CodeSphere/blob/master/.github/workflows/stable-linux.yml
- macOS: https://github.com/CodeSphere/CodeSphere/blob/master/.github/workflows/stable-macos.yml
- Windows: https://github.com/CodeSphere/CodeSphere/blob/master/.github/workflows/stable-windows.yml
...
# verify the snap
review-tools.snap-review --allow-classic codesphere*.snap
```
