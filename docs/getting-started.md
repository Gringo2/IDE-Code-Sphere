...
- Explore the [documentation](https://github.com/CodeSphere/CodeSphere/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/CodeSphere/CodeSphere/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/CodeSphere/CodeSphere/blob/master/CONTRIBUTING.md) if you're interested
