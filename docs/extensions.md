...
- [Extensions compatibility](https://github.com/CodeSphere/CodeSphere/blob/master/docs/extensions-compatibility.md)
...
A workaround exists to get debugging working in C# projects, by using Samsung's opensource [netcoredbg](https://github.com/Samsung/netcoredbg) package. See [this comment](https://github.com/CodeSphere/CodeSphere/issues/82#issue-409806641) for instructions on how to set that up.
