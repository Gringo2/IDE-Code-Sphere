...
This page explains how CodeSphere handles telemetry and how it enhances your privacy.
...
## <a id="announcements"></a>CodeSphere anouncements

The welcome page in CodeSphere displays announcements that are fetched via the internet from the project's GitHub repository.
